...
def gen_coord_dict(_coordinate_list):
    coords_dict = {}
    for vector in _coordinate_list:
...
def process_solution(_contents):
    ...
    coordinates_list = day_5_1.get_coordinates(_contents)
    ...
    # print(vents_matrix)
    danger_rating = 2
    return day_5_1.count_dangerous_areas(vents_matrix, danger_rating)
